...
--a)Salariul îl schimbați in Salariul_calculat,
BEGIN TRY
    BEGIN TRANSACTION
...
--b)Măriți Salariul_calculat la toți angajații din Departamentul1 cu 10 %
BEGIN TRY
    BEGIN TRANSACTION
...
--d)Eliminați câteva înregistrări după niște criterii la dorinta.
BEGIN TRANSACTION 
